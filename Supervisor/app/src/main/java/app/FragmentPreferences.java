...
public class FragmentPreferences extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        EditTextPreference editTextPref = (EditTextPreference) findPreference("numberPhone");
        editTextPref.setSummary(sp.getString("numberPhone", "0000000000"));
    ...
    private void tel_par_defaut() {
        ...
        editor.putString("numberPhone", "0000000000");
